...
computed styles (only of the divs to do overlap avoidance. The default background color can be overridden by passing
an optional options object, e.g. `{ backgroundColor: "transparent" }`.
