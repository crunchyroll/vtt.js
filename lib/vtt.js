...
function CueStyleBox(window, cue, styleOptions) {
  ...
  var styles = {
    ...
    opacity: styleOptions.fontOpacity || 1,
    position: "relative",
  ...
  styles = {
    ...
    opacity: styleOptions.windowOpacity || 1,
    whiteSpace: "pre-line",
    position: "absolute"
  };
...
WebVTT.processCues = function(window, cues, overlay, styles) {
  ...
  if (styles.fontOpacity) {
    styleOptions.fontOpacity = styles.fontOpacity;
  }
  if (styles.windowOpacity) {
    styleOptions.windowOpacity = styles.windowOpacity;
  }
